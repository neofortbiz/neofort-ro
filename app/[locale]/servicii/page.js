  ...
  const servicii = [
    {
      ...
      text: isRo ? 'In ultimii 5 ani am atins rezultate remarcabile in vanzarile off-plan, gratie unui portofoliu solid de cumparatori si investitori care ne-au acordat incredere. Majoritatea clientilor au achizitionat imobile la preturi suficient de discountate incat au preferat revanzarea inchirierii.' : isUk ? 'За останні 5 років ми досягли чудових результатів у продажах off-plan завдяки портфелю покупців та інвесторів. Більшість клієнтів придбали нерухомість за знижченими цінами і обрали перепродаж замість оренди.' : 'Over the last 5 years we achieved remarkable results in off-plan sales, backed by a strong portfolio of buyers and investors. Most clients purchased at sufficiently discounted prices to prefer resale over renting.',

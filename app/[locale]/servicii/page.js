...
export default async function ServiciiPage({ params }) {
  ...
  const row1 = [
    ...
    },
    {
      ...
      text: isRo
        ...
        : 'We provide project management consultancy and feasibility studies for developers and partner investors. In a competitive market, careful study of addressability and economic feasibility decisively guarantees the success of a real estate development. We rely on accumulated experience and predominantly prudential strategies.',
      img: '/images/Studii_de_fezabilitate.avif',
      imgAlt: isRo ? 'NEOFORT studii de fezabilitate proiecte imobiliare' : 'NEOFORT feasibility studies real estate projects',
      width: 307,
    },
    {
      title: isRo ? 'CONSTRUCTIE SI PROIECTARE' : 'CONSTRUCTION & DESIGN',
      subtitle: isRo ? 'Solutii complete de la proiect la cheie' : 'Complete solutions from design to turnkey',
      text: isRo
        ? 'Jucatorii cu experienta din piata dezvoltarilor imobiliare cunosc cel mai bine rolul proiectarii si constructiei intr-o viitoare dezvoltare. Oferim in parteneriate solutii la cerinte complexe de proiectare arhitecturala, design interior si coordonare executie. Toate garantate de o abordare profesionista bazata pe o experienta si expertiza verificata in timp.'
        : 'Experienced players in real estate development know best the role of design and construction. We offer partnership solutions for complex architectural design, interior design and execution coordination, guaranteed by a professional approach based on time-tested expertise.',
  ...
  const row2 = [
    ...
    {
      title: isRo ? 'TAMPLARIE ALUMINIU SI TERMOPANE PVC' : 'ALUMINIUM & PVC DOUBLE GLAZING',
